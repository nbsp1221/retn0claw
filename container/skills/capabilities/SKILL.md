---
name: capabilities
description: Show what this retn0claw instance can do — installed skills, available tools, and system info. Read-only. Use when the user asks what the bot can do, what's installed, or runs /capabilities.
---

# /capabilities — System Capabilities Report

Generate a structured read-only report of what this retn0claw instance can do.
...
- **MCP:** mcp__retn0claw__* (messaging, tasks, group management)

### 3. MCP server tools

The retn0claw MCP server exposes these tools (via `mcp__retn0claw__*` prefix):
