...
- **MCP:** mcp__retn0claw__* (send_message, schedule_task, list_tasks, pause_task, resume_task, cancel_task, update_task, register_group)
...
```
Call mcp__retn0claw__list_tasks to get scheduled tasks.
```
