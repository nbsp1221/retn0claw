/**
 * Stdio MCP Server for retn0claw
...
const chatJid = process.env.RETN0CLAW_CHAT_JID!;
const groupFolder = process.env.RETN0CLAW_GROUP_FOLDER!;
const isMain = process.env.RETN0CLAW_IS_MAIN === '1';
