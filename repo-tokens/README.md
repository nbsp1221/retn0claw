...
```yaml
- uses: nbsp1221/retn0claw/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [retn0claw](https://github.com/nbsp1221/retn0claw) | ![tokens](https://raw.githubusercontent.com/nbsp1221/retn0claw/main/repo-tokens/badge.svg) |
